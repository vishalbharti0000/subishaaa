...
scp -i "subishaaa.pem" subishaa-0.0.1-SNAPSHOT.jar ec2-user@ec2-44-211-129-46.compute-1.amazonaws.com:/home/ec2-user
...
#for login to ec2
#ssh -i "subishaaa.pem" ec2-user@ec2-44-211-129-46.compute-1.amazonaws.com
